...
// Handle checkboxes
$receipt_print = isset($_POST['receipt_print']) ? 1 : 0; // 1 if checked, 0 if not
$queue = isset($_POST['queue']) ? 1 : 0; // 1 if checked, 0 if not
...
// Handle selected actors (if applicable)
$selected_actors = isset($_POST['selected_actors']) ? json_decode($_POST['selected_actors'], true) : [];
...
$sql = "INSERT INTO events (
  ...
  mobile_price, mobile_currency, showtimes, selected_actors, receipt_print, queue
) VALUES (
